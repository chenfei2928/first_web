...
def update_document(wb):
    ...
    wb.find_element_by_xpath('//*[@id="soProjectInfoListtb"]/div[2]/span/a[3]/span/span').click() # 点击编辑按钮
    ...
    xmfzr = wb.find_element_by_xpath('/html/body/div/div[2]/form/table/tbody/tr[3]/td[2]/input') #项目负责人
  # xmfzr = wb.find_element_by_xpath('//*[@id="formobj"]/table/tbody/tr[3]/td[2]/input')
    xmfzr.clear()
    xmfzr.send_keys('刘邦')
