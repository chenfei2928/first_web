...
def view_document(wb):
    ...
    wb.find_element_by_xpath('//*[@id="soProjectInfoListtb"]/div[2]/span/a[1]/span/span').click() # 点击查看按钮
    ...
    wb.find_element_by_xpath(
        '/html/body/div[2]/table/tbody/tr[2]/td[2]/div/table/tbody/tr[3]/td/div/input').click()  # 关闭
