...
"""
https://github.com/selfteaching/the-craft-of-selfteaching/blob/master/Part.1.A.better.teachyourself.ipynb
"""

import matplotlib.pyplot as plt
import numpy as np

data = np.genfromtxt('life-expectancy-china-1960-2016',
                     delimiter=',',
                     names=['x','y']
                     )
